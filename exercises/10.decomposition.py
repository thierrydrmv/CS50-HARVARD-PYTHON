...
def exercise5():
  ...
  print(funny_phrase("she dreamed of being a runner")) # 'she dreeaameed of beeiing a ruunneer'
...
def exercise10():
  ...
  print(trendy_text("the weather will improve hopefully")) # 'th weathr wll improv hopeflly'
...
def exercise11():
  ...
  print(most_letter_word('she received an award for excellence in science', 'e')) # 'excellence'
  print(most_letter_word('she received an award for excellence in science', 'a')) # 'award'
...
def exercise12():
  ...
  print(lala_language('can you speak our language')) # 'can you spelealak our lalangulualagele'
